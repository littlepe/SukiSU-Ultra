...
static apk_sign_key_t apk_sign_keys[] = {
    { EXPECTED_SIZE_SHIRKNEKO, EXPECTED_HASH_SHIRKNEKO }, // SukiSU-Ultra - SukiSU-Ultra
    { EXPECTED_SIZE_RESUKISU, EXPECTED_HASH_RESUKISU }, // ReSukiSU - ReSukiSU
#ifdef CONFIG_KSU_MULTI_MANAGER_SUPPORT
    { EXPECTED_SIZE_WEISHU, EXPECTED_HASH_WEISHU }, // Official KSU
    { EXPECTED_SIZE_5EC1CFF, EXPECTED_HASH_5EC1CFF }, // 5ec1cff/KernelSU - MKSU
    { EXPECTED_SIZE_BACKSLASHXX, EXPECTED_HASH_BACKSLASHXX }, // backslashxx/KernelSU - xxKernelSU
    { EXPECTED_SIZE_RSUNTK, EXPECTED_HASH_RSUNTK }, // rsuntk/KernelSU -RKSU
    { EXPECTED_SIZE_KOWX712, EXPECTED_HASH_KOWX712 }, // KowX712/KernelSU - KowSU
    { EXPECTED_SIZE_RAPLI, EXPECTED_HASH_RAPLI }, // RapliVx/KernelSU - MamboSU
    { EXPECTED_SIZE_RIFSXD, EXPECTED_HASH_RIFSXD }, // KernelSU-Next - KernelSU-Next
    { EXPECTED_SIZE_WILDKERNELS, EXPECTED_HASH_WILDKERNELS }, //Wild_KSU - Wild SU
#ifdef EXPECTED_SIZE
