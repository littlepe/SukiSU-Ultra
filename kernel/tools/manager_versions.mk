...
$(info --   [4] RKSU:            $(KSU_VERSION_RKSU) = 30100+$(KSU_LOCAL_VERSION)$(RKSU_OFFSET))
$(info --   [5] KowSU:           $(KSU_VERSION_KOWSU) = 30000+$(KSU_LOCAL_VERSION)$(KOWSU_OFFSET))
$(info --   [6] MamboSU:         $(KSU_VERSION_MAMBOSU) = 40000+$(KSU_LOCAL_VERSION))
$(info --   [7] KernelSU-Next:   $(KSU_VERSION_NEXT) = 30000+$(KSU_LOCAL_VERSION)$(NEXT_OFFSET))
$(info --   [8] WildSU:          $(KSU_VERSION_WILDSU) = 30000+$(KSU_LOCAL_VERSION)$(WILDSU_OFFSET))
