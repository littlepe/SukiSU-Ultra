...
SUKISU_ULTRA_OFFSET := -2096
RESUKISU_OFFSET := 1262
WEISHU_KSU_OFFSET := -1295
MKSU_OFFSET := -1292
XXKSU_OFFSET := -1256
RKSU_OFFSET := -1506
KOWSU_OFFSET := 1223
MAMBOSU_OFFSET := -11295
NEXT_OFFSET := -667
WILDSU_OFFSET := -774
...
KSU_VERSION_MAMBOSU := $(shell expr 40000 + $(KSU_LOCAL_VERSION) + $(MAMBOSU_OFFSET))
